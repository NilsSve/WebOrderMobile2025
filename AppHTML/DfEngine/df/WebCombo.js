...
export class WebCombo extends WebBaseDEO {
    ...
    */
    ...
    updateFocus(bFocus) {
        ...
        //If we get the focus attempt to show the picker
        if (bFocus) {

            //Browsers do not like it when you forcefully show the picker without user interaction. Empty catch block to prevent users getting errors in their browser console.
            try {
